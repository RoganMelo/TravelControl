...
<body>
	<div id="container">
		...
		<div id="principal">
			<div id="cabecalho">
				<h3 id="titulo">Alterar Cidade</h3>
			</div>
			<div id="conteudo">
				<div id="inconteudo">
					<img align="left" id="hotel" src="Imagens/Cidade.png" />
					<form action="ServletCidade"
						onsubmit="return valida_pesquisa(this)" method="post">
						<b>Cidade:</b> <select id="cidade" name="cidade">
					...
					<form action="ServletCidade"
						...
						<input style="visibility: hidden;" name="cidadeAlterada"
							type="text" value="${cidade}"><br /> <b>Cidade: </b>${cidade}<br />
						<b>Hotel:</b> <select id="hoteis" name="hotelAlterado">
