...
<link rel="stylesheet" type="text/css"
	href="css/Style_Cadastro de Usuario.css" />
...
<body>
	<div id="container">
		...
		<div id="principal">
			...
			<div id="conteudo">
				<div id="inconteudo">
					<img id="cadeado" src="Imagens/Cadastro.jpg" />
					<form action="ServletUsuario" onsubmit="return valida_form(this)"
						...
						<br /> <br /> Clique <a href="Login.jsp">aqui</a> para fazer o
						login. <input type="text" id="method" name="operacao"
							value="cadastrar" style="visibility: hidden;" />
					</form>
