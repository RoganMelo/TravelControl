...
<link rel="stylesheet" type="text/css"
	href="css/Style_Cadastro de Cidades.css" />
...
<body>
	<div id="container">
		...
		<div id="principal">
			<div id="cabecalho">
				<h3 id="titulo">Cadastrar Cidade</h3>
			</div>
			<div id="conteudo">
				<div id="inconteudo">
					<img align="left" id="hotel" src="Imagens/Cidade.png" />
					<form action="ServletCidade" onsubmit="return valida_form(this)"
						method="post">
						<b>Cidade:</b><input id="cidade" type="text" name="cidade" /> <br />
						<br /> <b>Hotel:</b> <select id="hoteis" name="hotel">
					...
					<script type="text/javascript">
						function valida_form() {
							if (document.getElementById("cidade").value == "") {
								...
								return false
							} else if (document.getElementById("hoteis").value == "") {
								alert('Por favor, preencha o campo hotel');
								document.getElementById("hoteis").focus();
								return false
							} else
								alert('Cadastro de cidade feito com sucesso!');
						}
					</script>
				</div>
			</div>
